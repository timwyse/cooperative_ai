...
from src.game.agents import SONNET_4_5, FOUR_0, QWEN_3_235B, GPT_5_2
from src.game.constants import ANTHROPIC_API_KEY, OPENAI_API_KEY, POINTS_FOR_WIN
from src.game.model_adapter import ModelAdapter
from src.game.schemas import (STRICT_JUDGE_SCHEMA, ANTHROPIC_STRICT_JUDGE_TOOL, 
                     FINISHING_JUDGE_SCHEMA, ANTHROPIC_FINISHING_JUDGE_TOOL,
                     YES_NO_SCHEMA, ANTHROPIC_YESNO_TOOL)
from src.game.utils import get_last_alphabetic_word
