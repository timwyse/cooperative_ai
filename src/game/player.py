...
# Pathfinding helper
from src.game.player_helper import compute_best_routes
...
class Player:
    ...
    def format_turn_summary(self, turn_summary, turn_number, with_message_history=False):
        from src.game.turn_context import format_turn_summary_for_player
    ...
    def generate_player_context_message(self, game, grid):
        from src.game.turn_context import generate_turn_context
