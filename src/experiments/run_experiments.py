...
from src.game.agents import *
from src.game.logger import Logger
import argparse
from concurrent.futures import ThreadPoolExecutor, as_completed
from src.game.prompts import DEFAULT_SYSTEM_PROMPT, SELFISH_SYSTEM_PROMPT

NUM_WORKERS = 8

# Files
GRIDS_FILE = "configs/experiment_configs/4x4_experiment_grids_reduced.yaml"
